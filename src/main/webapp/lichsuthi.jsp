...
<div class="container" style="margin-top: 40px;">  
  <div class="row">
  	...
  	<% 
  	ArrayList <xacnhanthibean> dslichsu= (ArrayList<xacnhanthibean>) request.getAttribute("dshanglichsu");%>
  		
  		<% int n = 0;
  		if (dslichsu!=null || n==0){
  		 n = dslichsu.size();%>
  		<h2 >DANH SÁCH LỊCH SỬ MUA HÀNG</h2>
  		...
  		for (int i=0;i<n;i++){ 
  		 xacnhanthibean g = dslichsu.get(i);
  		%>
  	...
  	<% if(n==0 || dslichsu ==null){%>
		<h2>SẢN PHẨM CỦA BẠN ĐANG CHỜ XÁC NHẬN</h2>
	<%}%>
